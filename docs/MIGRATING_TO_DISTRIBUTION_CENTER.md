...
artifact `download_url`. Externally hosted artifacts use their supplied URL;
S3 artifacts use a time-limited signed GET URL generated by DistributionCenter.
